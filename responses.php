    ...
    <div class="d-flex">
        <div class="sidebar">
            <nav class="nav flex-column">
                <a class="nav-link" aria-current="page" href="dashboard_user.php"><i class="fas fa-exclamation-circle me-2"></i>Pengaduan</a>
                ...
                <ul class="list-group">
                    <?php foreach ($complaints as $complaint): ?>
                        <li class="list-group-item">
                            ...
                            ?>
                                <div class="mt-3">
                                    <h6>Balasan oleh: <?php echo htmlspecialchars($response['responder']); ?></h6>
                                    ...
                                    <?php endif; ?>
                                    <small>Diberikan pada: <?php echo htmlspecialchars($response['created_at']); ?></small>
                                </div>
                            <?php
                                endforeach;
                            else:
